define(['jQuery'], function ($) {
    ...
    */
    ...
    toString = Object.prototype.toString;
        ...
        // EXPORTS
        $.findClosestCulture = Globalization.findClosestCulture;
        $.culture = Globalization.culture;
        $.cultures = Globalization.cultures
        $.preferCulture = Globalization.preferCulture
        $.localize = Globalization.localize
        $.format = Globalization.format
        $.parseInt = Globalization.parseInt
        $.parseFloat = Globalization.parseFloat
        $.parseDate = Globalization.parseDate
